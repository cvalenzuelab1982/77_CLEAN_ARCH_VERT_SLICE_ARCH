...
namespace AutoAlquila.Domain.Alquileres
{
    public sealed class Alquiler : Entity
    {
        ...
        public static Alquiler Reservar(Vehiculo vehiculo, Guid usuarioId, RangoFechas duracion,DateTime fechaCreacion, PrecioService precioService)
        {
            ...
            alquiler.RaiseDomainEvent(new AlquilerReservaDomainEvent(alquiler.Id!));
